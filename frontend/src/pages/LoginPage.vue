...
async function fazerCadastro() {
  try {
    ...
    success.value = 'O cadastro foi feito com sucesso!'
  } catch (e) {
    error.value = 'Ocorreu um erro ao fazer o cadastro. Por favor tente novamente.'
    console.log(e)
  } finally {
    loading.value = false
  }
...
<template>
  ...
  <div class="d-flex justify-content-center">
    ...
    <div v-else>
      <form class="gy-5" @submit.prevent="handleForm">
        <svg
