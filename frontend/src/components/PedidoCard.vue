...
<template>
  ...
  <div
    v-else
    class="row d-flex flex-column flex-sm-row align-items-center justify-content-center mb-5 cardPedido"
  >
    <img :src="transformarLink(camiseta.Image.url)" class="col-3 image-cart d-block" />
    <div class="col-5">
      <table class="table">
        <tbody>
          <tr>
